  ...
  return (
    <header className="">
     <nav class="fixed top-0 left-0 w-full h-auto bg-gray-800 z-10 flex items-center justify-around">
      ...
      <h3 class="relative heading font-bold md:basis-1/6 text-2xl xs:basis-4/12 z-50 mb-5 mt-5">News Flow</h3>
        ...
        <ul className={active ? "nav-ul flex gap-11 md:gap-14 xs:gap-12 lg:basis-3/6 md:basis-4/6 md:justify-end active" : " nav-ul flex gap-14 lg:basis-3/6 md:basis-4/6 justify-end"}>
          ...
          <input type="checkbox" className="checkbox" id="checkbox" checked={theme === "dark-theme"} readOnly/>
              <label htmlFor="checkbox" className={`${theme === "dark-theme" ? "checkbox-label-dark" : "checkbox-label"}`}>
